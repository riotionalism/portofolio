...
export default function Home() {
 ...
 // DEFINISI ARRAY SKILLS & VARIANTS ADA DI SINI
  ...
  // Variasi animasi untuk elemen teks (FIXED EASE)
  const textVariants = {
  ...
  // Variasi animasi untuk foto (FIXED EASE)
  const imageVariants = {
    hidden: { opacity: 0, x: 100 },
    visible: { opacity: 1, x: 0, transition: { duration: 0.8, ease: [0.4, 0, 0.2, 1] as const, delay: 0.3 } },
  };

  // Variasi animasi untuk tombol (FIXED TYPE)
  const buttonVariants = {
    hidden: { opacity: 0, y: 20 },
    // FIX: Tambahkan 'as const' di "spring"
    ...
    <main>
      ...
      <section id="about" className="bg-gray-100 dark:bg-gray-800 py-16 transition-colors duration-300">
        <div className="container mx-auto px-8 max-w-4xl">
          <h2 className="mb-12 text-center text-3xl font-bold md:text-4xl text-gray-900 dark:text-white">About Me (NANTI DIGANTI BIAR LEBIH ENJOY!)</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <SkillCard title="RENCANA MAU DIBUAT TEMATIK" skills={technicalSkills} />
            <SkillCard title="RENCANA MAU DIBUAT SOFT_SKILLS" skills={softSkills} />
          </div>
          {/* --------------------- */}
        ...
        <div className="container mx-auto px-8">
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-lg transition-colors duration-300">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" className="font-semibold text-gray-800 dark:text-white hover:underline">Final Project: Karyarasa</a>
            </div>
